...
const sessions = [
  ...
  { n: 10, title: "Demo Day – זמן להתראות: מציגים את הפתרונות שיצרנו יחד" },
];

const audiences = [
  { title: "פסג\"ות", desc: "מסלול הכשרה רשמי 30 ש\"ש למורות ומורים מובילים במחוז." },
  { title: "מועצות מקומיות", desc: "קוהורט בית-ספרי או יישובי לפיתוח פתרונות לאתגרים המקומיים שלכם." },
  { title: "רשתות חינוך", desc: "תכנית פלאגשיפ לפיתוח חדשנות פדגוגית רוחבית ברשת." },
];
